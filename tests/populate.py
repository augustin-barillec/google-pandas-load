...
table_names_default = tuple('a{}_bq'.format(i) for i in range(8, 12))
blob_names_root_default = tuple('a{}_gs'.format(i) for i in range(9, 12))
blob_names_deep_default = tuple('dir/subdir/a{}_gs'.format(i)
                                for i in range(7, 11))
local_files_basenames_default = tuple('a{}_local'.format(i)
                                      for i in range(9, 14))
