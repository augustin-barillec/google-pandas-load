...
copyright = '2019, Augustin Barillec'
...
htmlhelp_basename = 'google-pandas-loaddoc'
...
latex_documents = [
    (master_doc, 'google-pandas-load.tex', 'google-pandas-load Documentation',
     'Augustin Barillec', 'manual'),
]
